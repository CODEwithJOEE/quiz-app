...
import {
  updateQuizStatus,
  deleteQuiz,
} from "@/src/app/[locale]/(dashboard)/rooms/[roomId]/quiz-actions";
        ...
        <div className="space-y-4">
          ...
          <Card className="p-5 space-y-4">
            <div className="flex items-center gap-2">
              ...
              <h2 className="font-semibold text-sm">{t("addQuestion")}</h2>
            </div>
            ...
            <Textarea
              placeholder={
                questionType === "essay"
                  ? t("questionPlaceholderEssay")
                  : t("questionPlaceholderMcq")
              }
              rows={3}
              value={qText}
    ...
    <li className="bg-card rounded-2xl border border-border shadow-sm p-4 space-y-3">
      ...
      {isEssay && (
        <div className="text-xs text-muted-foreground space-y-1">
          ...
          {question.rubric && (
            <p className="italic">
              <b>{t("rubricPrefix")}</b> {question.rubric}
            </p>
          )}
