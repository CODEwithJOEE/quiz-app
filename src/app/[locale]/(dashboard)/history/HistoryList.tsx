    ...
    <div className="space-y-3">
      <div className="space-y-2">
              ...
              <div className="flex flex-wrap gap-1.5">
                {(
                  [
                    ...
                    { value: "submitted", label: t("passedTaken") },
              ...
              <div className="flex flex-wrap gap-1.5">
                {(
                  [
                    ...
                    { value: "score_high", label: t("scoreHighLow") },
                    { value: "score_low", label: t("scoreLowHigh") },
        ...
        <p className="text-xs text-muted-foreground">
          {t("showing")} <b className="text-foreground">{processed.length}</b>{" "}
          {t("of")} {attempts.length}
        </p>
      </div>
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex flex-wrap gap-1.5 mt-1.5">
              <Badge variant={isTerminated ? "danger" : "success"}>
                {isTerminated ? t("statusTerminated") : t("statusSubmitted")}
              </Badge>
