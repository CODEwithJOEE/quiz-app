...
export default function RoomStudentsSection({
  ...
  roomId: string;
  accepted: any[]; // ← Change from Member[] to any[]
  pending: any[]; // ← Change from Member[] to any[]
  ...
  // Get selected names for modal preview
      ...
      >
        {accepted.length === 0 ? (
          <EmptyState
            ...
            description="Mag-invite ng students."
          />
        ) : (
          <>
            {/* Toolbar */}
