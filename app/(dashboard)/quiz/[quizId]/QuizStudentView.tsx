        ...
        <div className="grid grid-cols-2 gap-2 mt-4">
          ...
          <div className="bg-muted rounded-xl p-3">
            <div className="flex items-center gap-1.5 text-xs text-muted-foreground">
              ...
              {quiz.time_limit_minutes ? "Time Limit" : "Total Points"}
            </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <p className="font-semibold text-amber-900 dark:text-amber-200 text-sm">
              Basahin bago mag-start
            </p>
            <ul className="text-xs text-amber-800 dark:text-amber-300 mt-2 space-y-1.5">
              <li className="flex items-start gap-2">
                <Ban className="w-3.5 h-3.5 shrink-0 mt-0.5" />
                <span>
                  Once mag-start ka, <b>hindi ka na pwedeng mag-back</b>.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <EyeOff className="w-3.5 h-3.5 shrink-0 mt-0.5" />
                <span>
                  Huwag lumipat ng tab, mag-minimize, o lumabas ng fullscreen.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <AlertTriangle className="w-3.5 h-3.5 shrink-0 mt-0.5" />
                <span>
                  <b>3 violations = auto-terminate + score 0.</b>
                </span>
              </li>
              <li className="flex items-start gap-2">
                <ShieldAlert className="w-3.5 h-3.5 shrink-0 mt-0.5" />
                <span>
                  <b>One attempt only.</b> Walang retake.
                </span>
              </li>
            </ul>
          </div>
