...
import { ClipboardList, FileText, DoorOpen, CheckCircle2 } from "lucide-react";
...
export default async function QuizListPage() {
  ...
  // Super admin has no quizzes — send to home
  ...
  // =====================================================
  // STUDENT: published quizzes in rooms they're in
  // =====================================================
  const { data: quizzes } = await supabase
    .from("quizzes")
    .select(
